...
const S = {
  ...
  sub: { fontSize: 14, lineHeight: 1.66, color: 'var(--onb-text3, rgba(255,255,255,0.62))', margin: '0 0 20px' },
  ...
  formatChip: {
    ...
    color: 'var(--onb-text3, rgba(255,255,255,0.62))',
    fontFamily: 'Sora, sans-serif', fontWeight: 700, fontSize: 13, cursor: 'pointer',
    transition: 'background .15s, color .15s, border-color .15s',
  },
  formatChipOn: {
    background: 'var(--onb-accent-soft, rgba(168,85,247,0.16))',
    borderColor: 'var(--onb-accent, #c084fc)',
    color: 'var(--onb-text1, #fff)',
  },
  formatHint: { fontSize: 12, color: 'var(--onb-text4, rgba(255,255,255,0.45))', margin: '0 0 18px' },
  list: {
  ...
  row: {
    ...
    background: 'var(--onb-input, rgba(255,255,255,0.04))',
    border: '1px solid var(--onb-border, rgba(255,255,255,0.09))',
    color: 'var(--onb-text2, rgba(255,255,255,0.8))', cursor: 'pointer',
  ...
  rowTitle: { fontSize: 14, fontWeight: 600, color: 'var(--onb-text1, #fff)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
  rowMeta: { fontSize: 11.5, color: 'var(--onb-text4, rgba(255,255,255,0.45))' },
  empty: {
